...
export function TodayIcon({ size = 20, className = '' }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function ForecastIcon({ size = 20, className = '' }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function ProjectsIcon({ size = 20, className = '' }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function TagsIcon({ size = 20, className = '' }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function ReviewIcon({ size = 20, className = '' }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
